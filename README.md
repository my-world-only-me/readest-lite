...
[![Version](https://img.shields.io/badge/version-v8.8.0-6c5ce7)](https://github.com/cshdotcom/readest-lite/releases)
...
指定特定版本：`ghcr.io/cshdotcom/readest-lite:8.8.0`（每个版本都有对应 git tag）。
